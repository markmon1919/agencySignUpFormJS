(function($){
	...
	function formatYearEstablished() {
		...
		year.on('value-change', function() {
			...
			var json_str = JSON.stringify(year.getValue());
			console.log('json_str --> ' + json_str);
			console.log('test 1--> ' + JSON.deserializeUntyped(json_str));
			console.log('test 2--> ' + JSON.stringify(year.getValue(0));
			//console.log('year deserialize --> ' + JSON.deserialize(json_str));
		});
