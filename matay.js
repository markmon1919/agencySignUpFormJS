(function($){
	...
	*/
	...
	function returnHidden() {		
		//hiddenValue = loader.getEngine().getDocument().getElementById(dataId_hiddenReturnedAccount);
		phoneValue = loader.getEngine().getDocument().getElementById(dataId_phone);
		emailValue = loader.getEngine().getDocument().getElementById(dataId_email);
		dbaValue = loader.getEngine().getDocument().getElementById(dataId_dba);
		emailValue.on('value-change', function(){
			dbaValue.setValue(emailValue.getValue());
		});
