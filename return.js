(function($){
	...
	function returnHidden(){
		...
		hiddenReturnedAccount = loader.getEngine().getDocument().getElementById(dataId_hiddenReturnedAccount);
		dba = loader.getEngine().getDocument().getElementById(dataId_dba);

		dba.on('value-change', function(){
			//targetControlInstance.setValue( sourceControlInstance.getValue() );
			console.log('HIDDEN RETURNED ACCOUNT --->>> ' + hiddenReturnedAccount.getValue());
		});
