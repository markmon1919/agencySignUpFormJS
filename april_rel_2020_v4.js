(function($){
	...
	function returnHiddenValue(){
		var hiddenReturnedAccount = $("div[data-id='"+dataId_hiddenReturnedAccount+"']").val();
		...
		// 		console.log('hiddenReturnedAccount--->>> ' + JSON.stringify(hiddenReturnedAccount.getValue()));
		// 	});			
		console.log(hiddenReturnedAccount + " <-- hiddenReturnedAccount");
		console.log(hiddenReturnedAccount.length + " <-- hiddenReturnedAccount length");

		if (hiddenReturnedAccount.length != 0) {
			checker.val("True");
		}
