(function($){
	...
	function clearValues() {
		...
		var h = $("div[data-id='"+dataId_hiddenReturnedAccount+"']").val();
		var x = $("div[data-id='"+dataId_phone+"']").val();
		var y = $("div[data-id='"+dataId_email+"']").val();
		console.log(h + " dataId_hiddenReturnedAccount");
		console.log(x + " dataId_phone");
		console.log(y + " dataId_email");
		if ((h != "" && x == "" && y == "")) {
			alert("ALERT!");
