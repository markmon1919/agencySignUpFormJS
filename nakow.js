(function($){
	...
	*/
	...
	function returnHidden() {
		$("div[data-id='"+dataId_dba+"']").find("input")
			.on('keypress', function(e) {
				var dbaValue = $(this);
				var hiddenValue = $("div[data-id='"+dataId_hiddenReturnedAccount+"']").val();
				var phoneValue = $("div[data-id='"+dataId_phone+"']").val();
				var emailValue = $("div[data-id='"+dataId_email+"']").val();
				console.log('check hiddenValue -- ' + hiddenValue);
				console.log('check phoneValue -- ' + phoneValue);
				console.log('check emailValue -- ' + emailValue);
